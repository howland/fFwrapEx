...
IF (k .eqv. 0) THEN
   val = 1.0
ELSE IF (k .eqv. 1) THEN
   val = x
ELSE IF (k .eqv. 2) THEN
   val = 1.5*(x**2) - 0.5
ELSE IF (k .eqv. 3) THEN
   val = 2.5*(x**3) - 1.5*x
ELSE IF (k .eqv. 4) THEN
   val = (35.0*(x**4) - 30.0*(x**2) + 3.0)/8.0
ELSE IF (k .eqv. 5) THEN
   val = (63.0*(x**5) - 70.0*(x**3) + 15.0*x)/8.0
ELSE IF (k .eqv. 6) THEN
   val = (231.0*(x**6) - 315.0*(x**4) + 105.0*(x**2) - 5.0)/16.0
ELSE IF (k .eqv. 7) THEN
   val = (429.0*(x**7) - 693.0*(x**5) + 315.0*(x**3) - 35.0*x)/16.0
ELSE IF (k .eqv. 8) THEN
